...
export default function ZoomControls({ zoom, onZoomIn, onZoomOut, onFit }: Props) {
  ...
  return (
    <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-1.5 bg-white border border-krb-rule rounded-xl shadow-md px-3 py-1.5 select-none z-[20]">
